...
#	define __pragma(x) // MSVC pragmas, safe to ignore since we use them only to fix MSVC bugs...
	/* Linux still is at 2 or 4 sometimes (4 as of Debian Jessie) */
#	if __MINGW64_VERSION_MAJOR < 4
		/* fix non-conforming 'swprintf' from MSVC without size argument */
#		define swprintf _snwprintf
		/* fix some UUIDs missing from libuuid (GCC <4.8.3) */
		static const GUID CLSID_Shell = {0x13709620,0xc279,0x11ce,{0xa4,0x9e,0x44,0x45,0x53,0x54,0x00,0x00}};
